...
def render_feedback_section():
    ...
    # Add manual save to history button
...
def regenerate_content():
    ...
    with st.spinner("🔄 Adapting content based on your feedback..."):
        try:
            ...
            pdf_data = regenerate_pdf(new_output)
...
def regenerate_pdf(new_output):
    ...
    try:
        ...
        print(f"PDF regeneration failed: {pdf_error}")
        st.warning("⚠️ Content regenerated but PDF export failed. You can still copy the text above.")
        return None